...
export type VerticalStepPropertiesType = {
  className?: string;
  description?: React.ReactNode;
  title?: React.ReactNode;
};

export interface VerticalStepsProperties
   ...
   * @default []
   */
  steps?: VerticalStepPropertiesType[];
  /**
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      <div>
                        <div
                          className={cn(
                            "text-medium text-lg font-medium text-default-foreground transition-[color,opacity] duration-300 group-active:opacity-70",
                            {
                        ...
                        <div
                          className={cn(
                            "text-tiny text-default-600 transition-[color,opacity] duration-300 group-active:opacity-70 lg:text-medium",
                            {
                              "text-default-500": status === "inactive",
                            },
                          )}
